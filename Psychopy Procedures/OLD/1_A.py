...
participant_data.subj_id = gui.data[0]
age = gui.data[1]
gender = gui.data[2]
handedness = gui.data[3]
...
if os.path.exists(participant_data.subj_id+ '_stimCntr1.tsv'):
    sys.exit("File " + participant_data.subj_id+ '_stimCntr1.tsv' + " already exists!")
...
log = open(participant_data.subj_id + '_stimCntr1.tsv', 'w')
# define a header
...
ioSession = '1'
filename = participant_data.subj_id
...
shutil.move(participant_data.subj_id+'_stimCntr1.tsv', os.getcwd()+'/DATA_BEH')
